...
/**
  ...
  */
class LogicCaseTest extends FlatSpec {

  "Dada las siguientes operaciones aplicadas al cubo" should "deberia retornar querys exitosas caso 1" in {
  ...
  "Dada las siguientes operaciones aplicadas al cubo" should "deberia retornar querys exitosas caso 2" in {
    val cubeSum = CubeSummationLogic()
    val numCases = 1
  ...
  "Dada las siguientes operaciones erroneas aplicadas al cubo" should "deberia retornar una lista vacia" in {
    val cubeSum = CubeSummationLogic()
    val numCases = 1
